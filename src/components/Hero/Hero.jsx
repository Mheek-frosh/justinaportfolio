      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 w-full grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-bold leading-tight mb-6">
            Operations Professional <br/> & <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500">Graphic Designer</span>.
          </h1>
          ...
          <div className="flex flex-wrap gap-4">
            <a
              href="#contact"
              className="px-8 py-4 bg-white text-slate-950 font-bold rounded-full hover:bg-slate-200 transition-colors"
            >
              Get in Touch
            </a>
            <a
        ...
        >
          {/* Profile Image */}
          <div className="w-[400px] h-[500px] rounded-2xl bg-gradient-to-tr from-purple-500/20 to-pink-500/20 border border-white/10 backdrop-blur-3xl overflow-hidden relative shadow-2xl">
            <img 
              src="/image.png" 
